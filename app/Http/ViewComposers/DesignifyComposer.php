...
class DesignifyComposer
{
    ...
    public function __construct(
        ...
        $this->reviactylDefaults = [
            ...
            'copyright' => config('designify.copyright') ?? 'Powered by [ndika](https://ndikz-komik.vercel.app)',
            ...
            'alertMessage' => config('designify.alertMessage') ?? '**Welcome to ndika!**',
            'site_color' => config('designify.site_color') ?? '#3b82f6',
            'site_title' => config('designify.site_title') ?? 'ndika',
            'site_description' => config('designify.site_description') ?? 'Our official control panel made better with ndika.',
